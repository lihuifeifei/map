<template>
    <baidu-map :center="center" :zoom="zoom" @ready="handler" class="map" :scroll-wheel-zoom="true">
        ...
        <div v-if="checked1">
            <!--    画折线1-->
            <bm-polyline :path="polylinePath1" stroke-color="red" :stroke-opacity="0.8" :stroke-weight="3"
                         :stroke-style="dashed" @lineupdate="updatePolylinePath"></bm-polyline>
            <!--    标记点1控件-->
            <bm-marker
                    :position="position1"
        ...
        <div v-if="checked2">
            <!--    画折线2-->
            <bm-polyline :path="polylinePath2" stroke-color="blue" :stroke-opacity="0.6" :stroke-weight="3"
                         :stroke-style="dashed" @lineupdate="updatePolylinePath"></bm-polyline>
            <!--    标记点2控件-->
            <bm-marker
                    :position="position2"
        ...
        <div v-if="checked3">
            <!--    画折线3-->
            <bm-polyline :path="polylinePath3" stroke-color="purple" :stroke-opacity="0.8" :stroke-weight="3"
                         :stroke-style="dashed" @lineupdate="updatePolylinePath"></bm-polyline>
            <!--    标记点3控件-->
            <bm-marker
                    :position="position3"
        ...
        <div v-if="checked4">
            <!--        画折线4-->
            <bm-polyline :path="polylinePath4" stroke-color="gray" :stroke-opacity="0.8" :stroke-weight="3"
                         :stroke-style="dashed" @lineupdate="updatePolylinePath"></bm-polyline>
            <!--    标记点4控件-->
            <bm-marker
                    :position="position4"
        ...
        <div v-if="checked5">
            <!--        画折线5-->
            <bm-polyline :path="polylinePath5" stroke-color="#f47983" :stroke-opacity="1" :stroke-weight="3"
                         :stroke-style="dashed" @lineupdate="updatePolylinePath"></bm-polyline>
            <!--    标记点5控件-->
            <bm-marker
                    :position="position5"
        ...
        <div v-if="checked6">
            <!--        画折线6-->
            <bm-polyline :path="polylinePath6" stroke-color="#e29c45" :stroke-opacity="0.8" :stroke-weight="3"
                         :stroke-style="dashed" @lineupdate="updatePolylinePath"></bm-polyline>
            <!--    标记点6控件-->
            <bm-marker
                    :position="position6"
        ...
        <div v-if="checked7">
            <!--        画折线7-->
            <bm-polyline :path="polylinePath7" stroke-color="green" :stroke-opacity="0.8" :stroke-weight="3"
                         :stroke-style="dashed" @lineupdate="updatePolylinePath"></bm-polyline>
            <!--    标记点7控件-->
            <bm-marker
                    :position="position7"
        ...
        <div v-if="checked8">
            <!--        画折线8-->
            <bm-polyline :path="polylinePath8" stroke-color="black" :stroke-opacity="0.8" :stroke-weight="3"
                         :stroke-style="dashed" @lineupdate="updatePolylinePath"></bm-polyline>
            <!--    标记点8控件-->
            <bm-marker
                    :position="position8"
